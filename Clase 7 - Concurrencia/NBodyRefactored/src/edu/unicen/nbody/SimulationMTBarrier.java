...
import edu.unicen.nbody.threads.ProcessingBarrierExampleRunnable;
 ...
 */
public class SimulationMTBarrier extends JPanel{
    /**
     * 
     */
        ...
        public void actionPerformed(ActionEvent evt) 
        {
            ...
            if (arg.equals("Restart"))
            {
                ...
                Thread t = new Thread(() -> {
                    ...
                    //creates a barrier
                    CyclicBarrier barrier = new CyclicBarrier(numProc + 1);
                    ...
                    for(int i = 0; i < numProc; i++) {
                        ...
                        Thread thread = new Thread(new ProcessingBarrierExampleRunnable(barrier, init, end, bodies),
                                "Processing block " + i);
                        thread.start();
                        threads.add(thread);
                    }
