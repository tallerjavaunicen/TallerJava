...
public class EjercicioTree {
    ...
    public static void main(String[] args) {
        ...
        Tree[] trees = new Tree[]{createTree("(4,(1,(2,(3,,),(4,(1,,),)),),(2,,))"),
                createTree("(4,(1,(1,(1,,),(4,(1,,),)),),(2,,))"),
                randomTree(20000000, 1d)};
        for (Tree tree : trees) {
    ...
    public static int process(Tree t, int max, HashMap<Integer, Integer> path) {
        if (t == null)
            return 0;
        //
        ...
        Integer c = path.getOrDefault(t.x, 0);
        path.put(t.x, c + 1);
